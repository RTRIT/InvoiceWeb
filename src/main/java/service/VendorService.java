...
public class VendorService {
    ...
    // public List<Vendor> searchVendor(String name, String email, String
    // phonenumber) {
    // if (name==null && email==null && phonenumber==null) {
    // throw new AppException(ErrorCode.INVALID_SEARCH_CRITERIA);
    // }

    // List<Vendor> vendors = vendorRepository.searchVendor(name, phonenumber,
    // email);
    ...
    // public VendorResponse updateVendor(UUID vendorid, VendorCreationRequest
    // request) {
